...
var imgUrl = 'http://qiangke.oss-cn-beijing.aliyuncs.com',
   // globalUrl = 'http://www.qianke360.cn:8080/wcserv/appserv?s=';
    globalUrl = 'http://www.qianke360.cn:7006/wcserv/appserv';
...
// 提现
citesData.prototype.depositors = function(cashid, moneynmu, ways, accountid, token, callback) {
    //moneynmu 钱数
    // ways 收款帐号类别 
...
citesData.prototype.copyData = function(keyword, callback) {
    ...
    getdata(copydata, function(res, err) {
        callback(res, err);
    });
};
